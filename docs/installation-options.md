...
**What it does**:
1. Clones repository
2. Creates symlink: `hyaish-agents-plugin` → `hyaish-agents/claude/`
3. Runs verification
...
```bash
/plugin marketplace add hyaish/hyaish-agents
```
...
| **Agent Access** | `superpowers:code-reviewer` | `hyaish-agents/ansible-collection-swarm:lead-architect` |
