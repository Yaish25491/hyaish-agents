...
**Agent Namespace**: `hyaish-agents/ansible-collection-swarm:AGENT-NAME`
...
**Agent Namespace**: `hyaish-agents/windows-collection-swarm:AGENT-NAME`
...
All agents are namespaced as: `hyaish-agents/SWARM-NAME:AGENT-NAME`

### Universal Swarm Agents

- `hyaish-agents/ansible-collection-swarm:lead-architect`
- `hyaish-agents/ansible-collection-swarm:jira-ingestion-specialist`
- `hyaish-agents/ansible-collection-swarm:foundation-specialist`
- `hyaish-agents/ansible-collection-swarm:enhancement-specialist`
- `hyaish-agents/ansible-collection-swarm:platform-prerequisite-specialist`
- `hyaish-agents/ansible-collection-swarm:module-worker`
- `hyaish-agents/ansible-collection-swarm:qa-coordinator`
- `hyaish-agents/ansible-collection-swarm:refactor-specialist`
- `hyaish-agents/ansible-collection-swarm:release-specialist`
- `hyaish-agents/ansible-collection-swarm:ci-validation-specialist`
- `hyaish-agents/ansible-collection-swarm:learning-evolution-specialist`
...
The `hyaish-agents` plugin is designed to grow. Future swarms might include:
...
```
hyaish-agents/NEW-SWARM-NAME:AGENT-NAME
```
