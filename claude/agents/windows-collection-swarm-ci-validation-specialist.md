...
- Release Specialist successfully pushes to `https://github.com/Yaish25491/agentic-workflow-collections`
...
**GitHub Workflows**:
```bash
TEMP_REPO_URL="https://github.com/Yaish25491/agentic-workflow-collections"
COLLECTION_PATH="<namespace>/<name>"

# Check for GitHub workflows
gh api repos/Yaish25491/agentic-workflow-collections/actions/workflows \
...
gh api repos/Yaish25491/agentic-workflow-collections/actions/runs \
...
FAILED_RUNS=$(gh api repos/Yaish25491/agentic-workflow-collections/actions/runs \
...
# Get job logs
gh api repos/Yaish25491/agentic-workflow-collections/actions/runs/$RUN_ID/jobs \
...
gh api repos/Yaish25491/agentic-workflow-collections/actions/runs/$RUN_ID/rerun \
  --method POST
```
