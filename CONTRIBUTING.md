...
1. Check [existing issues](https://github.com/hyaish/hyaish-agents/issues) first
...
1. Open a [GitHub Discussion](https://github.com/hyaish/hyaish-agents/discussions)
2. Describe:
   - Use case
   - Proposed solution
...
ln -s $(pwd)/claude ~/.claude/agents/hyaish-agents-dev
...
# Test agent directly
Agent({
  subagent_type: "hyaish-agents/my-new-swarm:my-agent",
  prompt: "Test task"
})
```
...
- **General questions**: [GitHub Discussions](https://github.com/hyaish/hyaish-agents/discussions)
- **Bug reports**: [GitHub Issues](https://github.com/hyaish/hyaish-agents/issues)
- **Feature requests**: [GitHub Discussions](https://github.com/hyaish/hyaish-agents/discussions)
